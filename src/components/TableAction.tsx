...
export default function TableAction() {
  return (
    <div className="flex justify-between py-4 px-12 bg-white dark:bg-slate-700 rounded-lg items-center gap-8 ">
      <button
        className="
    ...
    "
      ...
      <div className=" flex-grow">
        ...
        <div className="relative">
          ...
          border border-gray-300 rounded-lg bg-gray-50 focus:ring-lime-500
          focus:border-lime-500 dark:bg-gray-500 dark:border-gray-600
          dark:placeholder-gray-400 dark:text-white
          dark:focus:ring-lime-500 dark:focus:border-lime-500 w-full
      
          "
            placeholder="Searh form items"
          />
        </div>
      </div>
